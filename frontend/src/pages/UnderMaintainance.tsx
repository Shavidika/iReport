    ...
    <div>
      <section className="bg-white dark:bg-gray-300">
        <div className="py-8 px-4 mx-auto max-w-screen-md text-center lg:py-16 lg:px-12">
          ...
          <h1 className="mb-4 text-4xl text-gray-950  text-gray-900font-bold tracking-tight leading-none text-gray-900 lg:mb-6 md:text-5xl xl:text-6xl dark:text-white">
            Under Maintenance
          </h1>
          <p className="font-light md:text-lg xl:text-xl dark:text-gray-400">
