...
const DraftArticles: React.FC<DraftArticlesProps> = ({ articles, onDraftClick, onComposeClick, className }) => {
  ...
  return (
    <div className={`bg-white rounded-3xl shadow-2xl border-2 ${className}`}>
      ...
      <div className="m-5 mt-2 overflow-auto">
        <h2 className="text-2xl font-bold text-center bg-gray-200 mb-4">Draft Articles</h2>
        {articles.length === 0 ? (
